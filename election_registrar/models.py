...
class Election(models.Model):
    ...
    election_title = models.CharField("Audience-facing display of election title", max_length=255, null=False, blank=False)
    election_caveats = models.TextField("Audience-facing display of election status", null=True, blank=True)
    election_kpcc_page = models.URLField("URL on KPCC.org hosting results", max_length=1024, null=True, blank=True)
...
class ResultSource(models.Model):
    ...
    source_all_precincts = models.BooleanField("100% precincts reporting", default=False)
