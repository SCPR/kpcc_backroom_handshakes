...
from newscast.views import NewscastIndexView, NewscastMapView, NewscastDetailView, NewscastCloseMeasuresView, NewscastCloseRacesView

app_name = "newscast"

urlpatterns = [

    url(r"(?P<electionid>[-\w]+)/playlist/map-presidential/$", NewscastMapView.as_view(), name="newscast_presidential_map"),
