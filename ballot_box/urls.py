...
urlpatterns = [
    url(r'results/featured/$', FeaturedIndex.as_view(), name="featured-index"),
    url(r'results/featured/index.html$', cache_page(60*10)(BakedFeaturedIndex.as_view()), name="baked-featured"),
    url(r'results/all/$', ResultIndex.as_view(), name="result-index"),
    url(r'results/all/index.html$', cache_page(60*10)(BakedResultsIndex.as_view()), name="baked-results"),
